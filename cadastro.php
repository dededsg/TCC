...
<body style="background-color: #040428;">
    <div class="container">
        <div class="row vh-100  align-items-center">
            <div>
                <a href="index.php" class="logo1">SlideIt</a>
            </div>
            <div class="col-md-10 mx-auto col-lg-5">
                <form action="insertUser.php" method="POST" class="mb-5 p-4 p-md-5 boder rounded-5 border border-primary" style="background-color: #ffffff00;">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" name="sobrenome" class="form-control" id="inputSobrenome" placeholder="Sobrenome" required>
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" name="email" class="form-control" id="inputEmail" placeholder="E-mail" required>
                    ...
                    <div class="form-floating mt-5 mb-5">
                        <button class="btn btn-lg btn-outline-primary w-100" type="submit" style="color: white;" name="submit">
                            Cadastrar
                        </button>
                    </div>
