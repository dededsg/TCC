      ...
      <nav class="navbar navbar-expand-sm">
        ...
        <div class="col-sm-4 d-sm-block d-none">
          <ul class="navbar-nav justify-content-center">
            ...
            <li class="nav-item"><a style="text-decoration: underline; text-underline-offset: 4px; font-weight: bold" class="nav-link" href=" poliuso.php "> Política de uso </a></li>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarContent">
          ...
          <ul class="navbar-nav col-sm-6 d-sm-none d-block"> 
            <li class="nav-item"><a class="nav-link" href="sobre.php"> Início </a></li>  
